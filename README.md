...
|---------|-------|-----------------|
| Database (JDBC) | `192.168.5.58:8563` | `52.28.97.243:8563` |
| Admin UI | `https://192.168.5.58:8443` | `https://52.28.97.243:8443` |
| Admin API | `192.168.5.58:4444` | `52.28.97.243:4444` |
| BucketFS | `192.168.5.58:2580-2581` | `52.28.97.243:2580-2581` |
